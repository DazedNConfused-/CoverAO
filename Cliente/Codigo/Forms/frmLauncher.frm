...
Begin VB.Form frmLauncher 
   ...
   Begin VB.ComboBox Combo1 
      ...
      Enabled         =   0   'False
      Height          =   315
      ItemData        =   "frmLauncher.frx":380D2
      Left            =   480
      List            =   "frmLauncher.frx":380D4
      TabIndex        =   3
      Top             =   2880
      Width           =   4510
   End
   ...
   Begin VB.ComboBox Combo2 
      Enabled         =   0   'False
      Height          =   315
      ItemData        =   "frmLauncher.frx":380D6
      Left            =   480
      List            =   "frmLauncher.frx":380DD
      TabIndex        =   1
      Text            =   "800x600 @ 16"
      Top             =   3600
      Width           =   2655
   ...
   Begin VB.Image image1 
      ...
      Index           =   1
      Left            =   5760
      MouseIcon       =   "frmLauncher.frx":4B43B
   ...
   Begin VB.Image image1 
      ...
      Index           =   0
      Left            =   290
      MouseIcon       =   "frmLauncher.frx":4B58D
      MousePointer    =   99  'Custom
      Tag             =   "1"
      Top             =   6120
      Width           =   1755
   ...
   Begin VB.Image image1 
      ...
      Index           =   6
      Left            =   6075
      MouseIcon       =   "frmLauncher.frx":4B6DF
      MousePointer    =   99  'Custom
      Tag             =   "1"
      Top             =   5190
      Width           =   1350
   ...
   Begin VB.Image image1 
      ...
      Index           =   5
      Left            =   4640
      MouseIcon       =   "frmLauncher.frx":4B831
      MousePointer    =   99  'Custom
      Tag             =   "1"
      Top             =   5190
      Width           =   1350
   ...
   Begin VB.Image image1 
      ...
      Index           =   4
      Left            =   3180
      MouseIcon       =   "frmLauncher.frx":4B983
      MousePointer    =   99  'Custom
      Tag             =   "1"
      Top             =   5190
      Width           =   1350
   ...
   Begin VB.Image image1 
      ...
      Index           =   3
      Left            =   1740
      MouseIcon       =   "frmLauncher.frx":4BAD5
      MousePointer    =   99  'Custom
      Tag             =   "1"
      Top             =   5190
      Width           =   1350
   ...
   Begin VB.Image image1 
      ...
      Index           =   2
      Left            =   285
      MouseIcon       =   "frmLauncher.frx":4BC27
      MousePointer    =   99  'Custom
      Tag             =   "1"
      Top             =   5190
      Width           =   1350
   ...
   Begin VB.Label INFO 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Bienvenidos de Cover AO, has click en inicias el juego para jugar"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
