...
'***************************************************
    ...
    If Left$(Comando, 1) = "/" Then
        ...
        Select Case Comando
            ...
            Case "/CERRARCLAN"
                 Call writeCloseGuild 'Gracias luuq Por el Codigo.
           ...
           Case "/MOTD"
            ...
            Case "/FUNDARCLAN"
                ...
                Else
                    Call ShowConsoleMsg("Para fundar un clan tenés que ser nivel 25 y tener 100 skills en liderazgo.")
                End If
            ...
            Case "/LLUVIA2"
                Call WriteRainToggle(2)
            
            Case "/TRUENO"
                Call WriteRainToggle(1)
            ...
            Case "/CI"
                If notNullArguments And CantidadArgumentos > 1 Then
                    If ValidNumber(ArgumentosAll(0), eNumber_Types.ent_Long) And ValidNumber(ArgumentosAll(1), eNumber_Types.ent_Long) Then
                ...
                Else
                    'Avisar que falta el parametro
                    If CantidadArgumentos = 1 Then Call WriteCreateItem(ArgumentosAll(0), 1)
                End If
