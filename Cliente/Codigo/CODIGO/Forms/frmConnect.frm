...
Begin VB.Form frmConnect 
   ...
   Begin VB.ListBox lst_servers 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   1980
      ItemData        =   "frmConnect.frx":25A82
      Left            =   6720
      List            =   "frmConnect.frx":25A84
      TabIndex        =   0
      Top             =   2160
      Width           =   2925
   End
...
Private Sub Form_Load()
    ...
    lServer(2).name = "Tempeo(Exp x50 Oro x40)(online)"
    
    lst_servers.AddItem lServer(1).name
    lst_servers.AddItem lServer(2).name

    WebBrowser1.Navigate "http://www.coverAO.jimdo.com"
