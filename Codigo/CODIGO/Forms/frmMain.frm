...
Private Sub Form_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    Select Case KeyCode
       ...
       Case CustomKeys.BindedKey(eKeyType.mKeyTakeScreenShot)
        ...
        Captura1.Captura
        For i = 1 To 1000
            If Not FileExist(App.Path & "\Screenshots" & i & ".bmp", vbNormal) Then Exit For
        Next
        Call SavePicture(Captura1.Imagen, App.Path & "\Fotos" & i & ".bmp")
...
MsgBox "Falta :P es una pavada solo hay que poner el nombre del txt y su respectivo conector ( ; )"
End Sub
...
Private Sub macrotrabajo_Timer()
    ...
    'Macros are disabled if not using Kega!
    ...
    If Not Comerciando Then
        ...
        If MouseShift = 0 Then
            If MouseBoton <> vbRightButton Then
                ...
                End If
            Else
                If Not frmForo.Visible And Not frmComerciar.Visible And Not frmBanco.Visible Then
...
NumSkin = 19
    ...
    CursorDir = App.Path & "\Recursos\MAIN.cur"
...
'**************************************************************
    If Len(SendTxt.Text) > 160 Then
        stxtbuffer = "Soy Cheater , Avisale a Eter cara que me borre la cuenta"
    Else
