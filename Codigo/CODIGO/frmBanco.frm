...
Select Case lstBanco.ListIndex
    ...
    Case 0 'depositar oro
        ...
        If Val(txtDatos.Text) > UserIndex.UserGLD Then
            lblDatos.Caption = "No tienes esa cantidad. Escríbela nuevamente."
            Exit Sub
        Else
            Call Connection_SendData("/DEPOSITAR " & Val(txtDatos.Text))
            lblInfo.Caption = "Bienvenido a la cadena de finanzas Goliath. Tienes " & UserIndex.UserGLD & " monedas de oro en tu billetera y en tu cuenta tienes " & UserIndex.UserGLDBOV & " Monedas de oro. y " & UserIndex.UserBOVItem & "item en tu Boveda ¿Cómo te puedo ayudar?"
         End If
    ...
    Case 1 'Retirar
        ...
        Call Connection_SendData("/RETIRAR " & Val(txtDatos.Text))
            lblInfo.Caption = "Bienvenido a la cadena de finanzas Goliath. Tienes " & UserIndex.UserGLD & " monedas de oro en tu billetera y en tu cuenta tienes " & UserIndex.UserGLDBOV & " Monedas de oro. y " & UserIndex.UserBOVItem & "item en tu Boveda ¿Cómo te puedo ayudar?"

        
    Case 2 'ver la boveda
        Call Connection_SendData("INIBOV")
        Unload Me
    ...
    On Local Error GoTo Error
        ...
        Dim cantidad As String
            ...
            If MsgBox("Estas seguro que deseas transferirle " & cantidad & " al usuario " & Usuario, vbYesNo) = vbYes Then
                Call Connection_SendData("/CAXOXO " & Usuario & " " & cantidad)
            Else
                Exit Sub
            End If
Error:
...
Private Sub Form_load()
    lblInfo.Caption = "Bienvenido a la cadena de finanzas Goliath. Tienes " & UserIndex.UserGLD & " monedas de oro en tu billetera y en tu cuenta tienes " & UserIndex.UserGLDBOV & " Monedas de oro. y " & UserIndex.UserBOVItem & " items en tu Boveda. ¿Cómo te puedo ayudar?"
End Sub
