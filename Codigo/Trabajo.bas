...
If res < (UserList(UserIndex).Stats.UserSkills(eSkill.artes) / 4) Then
    ...
    Call WriteConsoleMsg(1, UserIndex, "Tu golpe ha dejado inmóvil a tu oponente", FontTypeNames.FONTTYPE_INFO)
    Call WriteConsoleMsg(1, VictimaIndex, "¡El golpe te ha dejado inmóvil!", FontTypeNames.FONTTYPE_INFO)
    If TieneObjetos(869, 1, UserIndex) Then Exit Sub
End If
