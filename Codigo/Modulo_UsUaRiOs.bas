...
Call WriteConsoleMsg(1, UserIndex, "¡Has mejorado tu skill " & SkillsNames(Skill) & " en un punto!. Ahora tienes " & UserList(UserIndex).Stats.UserSkills(Skill) & " pts.", FontTypeNames.FONTTYPE_INFO)
...
On Error GoTo ErrorHandler
    ...
    If UserList(UserIndex).flags.EnDeath = 1 Then
        'Call WarpUserChar(UserIndex, 34, 85, 45, True)
